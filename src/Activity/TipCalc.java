 ...
 * TipCalc() => constructs the TipCalc with defaults getBillAmount() => gets
 * Bill Amount property setBillAmount(billAmount) => sets the bill amount
 * property getTipPct() => gets the tip pct property setTipPct(tipPct) => sets
 * the tip pct property tipAmount() => calculates the amount of the tip
